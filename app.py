...
# ============================================================
# !pip install langgraph langchain langchain-anthropic anthropic ifcopenshell pandas openpyxl python-docx -q  # executar no terminal se necessário
...
# Para execução local, definir a variável de ambiente antes de correr:
#   export ANTHROPIC_API_KEY="sk-ant-..."       (Linux/Mac)
#   set ANTHROPIC_API_KEY=sk-ant-...            (Windows)
# Ou descomentar a linha abaixo e introduzir directamente (não recomendado em produção):
...
if "ANTHROPIC_API_KEY" in os.environ:
    ...
    import getpass
    os.environ["ANTHROPIC_API_KEY"] = getpass.getpass("Introduz a ANTHROPIC_API_KEY: ")
...
# from google.colab import files  # apenas no Google Colab
# files.download("relatorio_inspector.docx")  # apenas no Google Colab
# files.download("checklist_conformidade.xlsx")  # apenas no Google Colab
# files.download("log_inspector.json")  # apenas no Google Colab
